...
<body class="childrenBody">
	...
	function getLangDate(){
	    ...
	    document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，"+timeValue+"好！ 欢迎使用宿舍管理系统。当前时间为： "+newDate+"　"+week;
	...
	layui.use(['form','element','layer','jquery'],function(){
	    ...
	    //最新文章列表
	    $.get("${cb}/news/loadAllNews.action?page=1&limit=10",function(data){
	        var hotNewsHtml = '';
	...
	function viewNews(id){
		$.get("${cb}/news/loadNewsById.action",{id:id},function(news){
			layer.open({
				type:1,
				title:'查看公告',
